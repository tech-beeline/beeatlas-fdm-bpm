...
public class ApplicationProcessService {
    ...
    public void applicationProcess(String processInstanceId, String businessKey, Integer authorId, String type,
        ...
        log.info("Устанавливаем переменные в контекст процесса. applicationId: {}, typeId: {}", saveApplication.getId(), applicationTypeEnum.getId());
    ...
    public void sendGroupNotifications(Integer applicationId, String type, Integer typeId) {
        ...
        for (ExecutorRoles role : executorRoles) {
            log.info("Отправка уведомления для роли. role: {}, type: {}, applicationId: {}", role.getRole(), type, applicationId);
